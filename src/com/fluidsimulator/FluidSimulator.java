...
//screen is the window UI implementation, and the InputProcessor is the inteface that
//implements event processing from user inputs
public class FluidSimulator implements Screen, InputProcessor {
	...
	public static final float LINE_VELOCITY_FACTOR = 0.3f;
	public static final int LINE_DENSITY_FACTOR = 5;
	...
	public static final int wpadding = 20;
	public static final int hpadding = 20;
	public static final float collisionForce = 0.3f;
	public static final int SCREEN_WIDTH = (int)Toolkit.getDefaultToolkit().getScreenSize().getWidth();
	public static final int SCREEN_HEIGHT = (int)Toolkit.getDefaultToolkit().getScreenSize().getHeight();
	protected SpriteBatch batch;
	protected BitmapFont font;
	//the view, same as glut functions for viewing
	protected OrthographicCamera camera;

	private SpatialTable<Particle> particles = new SpatialTable<Particle>(
			WORLD_WIDTH, WORLD_HEIGHT) {

		//i didnt really understand this position calculation, both for X and Y
		@Override
